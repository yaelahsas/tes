	...
	<section id="about" class="about">
		<div class="container" data-aos="fade-up">
			...
			<div class="section-title">
				<h2>PANAH</h2>
				<p>
					PANAH adalah suatu inovasi layanan pengantaran obat yang dilakukan oleh instalasi farmasi RSUD Genteng yang kerja sama dengan aplikasi JOKER dengan sistem pembayaran COD oleh pasien.
					Malas antri obat PANAHIN aja
				</p>
			</div>
...
">Alur</a>
	...
	<section id="gallery" class="gallery">
		<div class="container" data-aos="fade-up">
			<div class="section-title">
				<h2>Gallery</h2>
				<p>Beberapa foto masyarakat yang telah menggunakan Inovasi PANAH</p>
			</div>
				...
				<div class="row justify-content-center">
					<div class="col-md-4">
						...
						<div class="card page-view-card text-center">
							<div class="card-body">
								<h3>Berikan penilaian kepada PANAH</h3>
								<div class="rating">
