	...
	<section id="hero">
		<div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
            ...
            <a href="#about" class="btn-get-started scrollto">Read More</a>
				...
				<!-- Slide 3 -->
				<div class="carousel-item" style="background-image: url(assets/front/img/slide/layanan_unggulan1.png)">
					<div class="container">
						<h2>Layanan Unggulan</h2>
						<p>Layanan unggulan kami yang sangat unggulan</p>
						<a href="#featured-services" class="btn-get-started scrollto">Read More</a>
					</div>
				</div>
				<!-- Slide 4 -->
				<div class="carousel-item" style="background-image: url(assets/front/img/slide/poli_jantung2.png)">
					<!-- <div class="container">
